...
export const initDatabase = async () => {
  try {
    ...
    if (testUser.length === 0) {
      ...
      console.log('[DB] Тестовый пользователь добавлен');
    } else {
...
export const getProducts = async () => {
  ...
  try {
    ...
    console.error('[getProducts] Ошибка:', error);
    return [];
  }
};
...
export const getProductById = async (productId) => {
  ...
  try {
    ...
    console.error('[getProductById] Ошибка:', error);
    return null;
  }
};
...
export const getProductsByCategory = async (category) => {
  ...
  try {
    ...
    console.error('[getProductsByCategory] Ошибка:', error);
    return [];
  }
};
...
export const searchProducts = async (query) => {
  ...
  try {
    ...
    console.error('[searchProducts] Ошибка:', error);
    return [];
  }
};
...
export const getCartItems = async (userId) => {
  ...
  try {
    ...
    console.error('[getCartItems] Ошибка:', error);
    return [];
  }
};
...
export const removeFromCart = async (cartItemId) => {
  ...
  try {
    ...
    console.error('[removeFromCart] Ошибка:', error);
    return false;
  }
};
...
export const updateCartQuantity = async (cartItemId, quantity) => {
  ...
  try {
    ...
    console.error('[updateCartQuantity] Ошибка:', error);
    return false;
  }
};
...
export const clearCart = async (userId) => {
  ...
  try {
    ...
    console.error('[clearCart] Ошибка:', error);
    return false;
  }
};
...
export const checkEmailExists = async (email) => {
  ...
  try {
    ...
    console.error('[checkEmailExists] Ошибка:', error);
    return false;
  }
};
...
export const getUserByEmail = async (email) => {
  ...
  try {
    ...
    console.error('[getUserByEmail] Ошибка:', error);
    return null;
  }
};
...
export const getUserById = async (userId) => {
  ...
  try {
    ...
    console.error('[getUserById] Ошибка:', error);
    return null;
  }
};
...
export const updateLoyaltyPoints = async (userId, points) => {
  ...
  try {
    ...
    console.error('[updateLoyaltyPoints] Ошибка:', error);
  }
};
...
export const getOrdersByUserId = async (userId) => {
  ...
  try {
    ...
    console.error('[getOrdersByUserId] Ошибка:', error);
    return [];
  }
};
...
export const getOrderItems = async (orderId) => {
  ...
  try {
    ...
    console.error('[getOrderItems] Ошибка:', error);
    return [];
  }
};
...
export const getPromotions = async () => {
  ...
  try {
    ...
    console.error('[getPromotions] Ошибка:', error);
    return [];
  }
};
...
export const getPopularProducts = async (limit = 10) => {
  ...
  try {
    ...
    console.error('[getPopularProducts] Ошибка:', error);
    return [];
  }
};
